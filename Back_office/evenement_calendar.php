...
foreach ($events as $event) {
    array_push($events_calendar, [
        "title" => $event['nom_evenement'],
        "start" => $event['date_evenement'],
        "end" => date('Y-m-d H:i:s', strtotime("+1 day", strtotime($event['date_evenement']))),
    ]);
}
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            var calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                events: <?php echo json_encode($events_calendar); ?>
            });
            calendar.render();
        });
    </script>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="evenement.php" class="nav-item nav-link"><i class="fa fa-calendar me-2"></i>Events</a>
                    <a href="evenement_calendar.php" class="nav-item nav-link active"><i class="fa fa-calendar-alt me-2"></i>Events Calendar</a>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">Calendrier des Evenements</h6>
                            <div id='calendar'></div>
                        </div>
                    </div>
                </div>
