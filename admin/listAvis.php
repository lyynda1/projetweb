    ...
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="listReclamations.php" class="nav-item nav-link "><i class="fa fa-keyboard me-2"></i>FeedBacks</a>
                    <a href="listAvis.php" class="nav-item nav-link active"><i class="fa fa-star me-2"></i>Reviews</a>
                </div>
            </nav>
        </div>
        <!-- Sidebar End -->
        ...
        <div class="row g-4">
            ...
            <?php 
                ...
                for ($i = 1; $i <= 5; $i++) {
                    if ($i <= $rate) {
                        echo '<i class="fa fa-star"></i>'; // Full star
                    } else {
                        echo '<i class="fa fa-star-o"></i>'; // Empty star
                    }
                }
            ?>
        </td>                                    <td><?php echo $avis['date']; ?></td>
                                        <td>
                                            <form action="deleteAvis.php" method="post" onsubmit="return confirm('Are you sure you want to delete this Feedback?');">
