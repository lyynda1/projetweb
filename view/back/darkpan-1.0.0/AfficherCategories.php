            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row g-4">
                    ...
                    <div class="col-12">
                        ...
                        <a href="AjouterCategorie.php" class="btn btn-primary">Ajouter Categorie</a>
                        <br><br>
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                    <tr>
                                                <th scope="row"><?php echo $categorie['idC']; ?></th>
                                                ...
                                                <td>
                                                <a  class="btn btn-danger " href="SupprimerCategorie.php?idC=<?php echo $categorie['idC']; ?>">Supprimer</a>
                                                </td>
                                            </tr>
