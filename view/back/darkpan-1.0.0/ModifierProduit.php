                        ...
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <form method="POST" class="forms-sample" name="form"  id="form" enctype="multipart/form-data" onsubmit="return validateForm();">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="nomProduit" name="nomProduit" placeholder="Entrez le nom du produit" value="<?php echo $produit['nomProduit'];?>">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="prix" name="prix" placeholder="Entrez le prix" value="<?php echo $produit['prix'];?>">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="description" name="description" placeholder="Entrez le Description" value="<?php echo $produit['description'];?>">
                                ...
                                <select class="form-select"name="categorie" id="categorie">
                                       <?php
                                            $listCat = $CategorieC->AfficherCategorie();
                                             foreach($listCat as $categorie){
                                            $idC = $categorie['idC'];
                                            ?>
                                            <option value="<?php echo $categorie['idC']; ?>" <?php if ($produit['categorie'] == $idC) echo "selected"; ?>><?php echo $categorie['nomC']; ?></option>
                                           <?php
                                            }
                                           ?>
                                </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="file" class="form-control" id="image" name="image"  value="<?php echo $produit['image'];?>">
                                    <div id="imgerror" class="error-message"></div>
                                    <span>Image : <?php echo basename($produit['image']); ?></span>
                                </div>
