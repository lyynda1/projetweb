...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'add_reservation') {
        ...
        header('Location: ../view/front/events.php?message=created'); // Redirect to index page
        exit();
    }
    ...
    if ($action === 'update_reservation') {
        ...
        header('Location: ../view/back/evenement.php?message=updated'); // Redirect to index page
        exit();
    }
    if ($action === 'delete_reservation') {
        $id_reservation = $_POST['id_reservation'];
        $reservationController->deleteReservation($id_reservation);
        header('Location: ../view/back/evenement.php?message=deleted');
        exit();
    }
}
/*
