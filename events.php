...
<head>
	...
	<body>
		...
		* Use class "gl-search-dark" to enable global search dark style.
		...
		<!-- Begin top filter 
		======================
		* Use class "tf-dark" to enable top filter dark style.
		-->
		<div id="top-filter" class="top-f tf-dark">
			<div class="top-filter-inner">
			
				<!-- Begin top filter close button -->
				<div class="top-filter-close-wrap">
					<a href="#0" class="top-filter-close" title="Close">
						<i class="fas fa-close"></i>
					</a>
				</div>
				<!-- End top filter close button -->
						...
						<div class="col-md-12">
							...
							<div class="isotope-filter text-center">
								...
								<ul class="isotope-filter-links">
									<li><a href="#portfolio-list-section" class="sm-scroll active" data-filter="*">All</a></li>
									<li><a href="#portfolio-list-section" class="sm-scroll" data-filter=".print">Print</a></li>
									<li><a href="#portfolio-list-section" class="sm-scroll" data-filter=".web-design">Web Design</a></li>
									<li><a href="#portfolio-list-section" class="sm-scroll" data-filter=".photography">Photography</a></li>
									<li><a href="#portfolio-list-section" class="sm-scroll" data-filter=".motion">Motion</a></li>
								</ul>
		...
		<div id="header">
			...
			* Use class "slide-left", "slide-left-half", "slide-right", "slide-right-half", "slide-top", "slide-bottom" or "zoom-in" to change menu effect.
						...
						<div class="menu-nav">
							<ul class="menu-list">
								...
								<li class="has-children active">
									...
									<ul class="sub-menu">
										<li><a href="portfolio-list.html">event</a></li>
									</ul>
								</li>
								<li class="has-children">
			...
			<div id="header-attriputes">
				...
				<ul>
					<li>
						<!-- Begin top filter trigger -->
						<div id="top-filter-trigger">
							<a href="#0" class="top-filter-icon" title="Filter">
								<i class="fas fa-sliders-h"></i>
							</a>
						</div>
						<!-- End top filter trigger -->
					</li>
				</ul>
		...
		<div id="body-content">
			...
			<div id="content-container">
				...
				<section id="page-header" data-percent-height="0.9">
					...
					<div class="page-header-image parallax fade-out-scroll-6 bg-image" style="background-image: url(assets/img/page-header/page-header-bg-1.jpg); background-position: 50% 30%;">
						...
						<a href="#portfolio-list-section" class="scroll-down sm-scroll hide-from-sm" title="Scroll down"></a>
							...
							<div class="isotope-items-wrap pli-caption-alter">
								...
								* If you use background image on isotope-item child element, then you need to use class "iso-height-1" or "iso-height-2" to set the item height. If you use simple image tag, then don't use height classes.
								...
								<div class="isotope-item iso-height-2 print">
									...
									<a href="event_el_jam.php" class="portfolio-list-item bg-image" style="background-image: url(assets/img/porfolio/portfolio-2.jpg); background-position: 50% 50%">
										<div class="pli-hover">
											<div class="pli-caption">
												<div><h2 class="pli-title">Event at Masrah Al Jam</h2></div>
												<div><span class="pli-category">Tunisia</span></div>
											</div>
								...
								* If you use background image on isotope-item child element, then you need to use class "iso-height-1" or "iso-height-2" to set the item height. If you use simple image tag, then don't use height classes.
								-->
								<div class="isotope-item iso-height-1 print motion">

									<!-- Begin portfolio list item -->
									<a href="portfolio-single-2.html" class="portfolio-list-item bg-image" style="background-image: url(assets/img/porfolio/portfolio-1.jpg); background-position: 50% 50%">
										<div class="pli-hover">
											<div class="pli-caption">
								...
								* If you use background image on isotope-item child element, then you need to use class "iso-height-1" or "iso-height-2" to set the item height. If you use simple image tag, then don't use height classes.
								-->
								<div class="isotope-item iso-height-1 print">

									<!-- Begin portfolio list item -->
									<a href="event_sidi_bou.php" class="portfolio-list-item bg-image" style="background-image: url(assets/img/porfolio/portfolio-3.jpg); background-position: 50% 50%">
										<div class="pli-hover">
											<div class="pli-caption">
												<div><h2 class="pli-title">Event at Sidi Bou Saïd</h2></div>
												<div><span class="pli-category">Tunisia</span></div>
											</div>
											<div class="pli-arrow"></div>
										</div>
								...
								* If you use background image on isotope-item child element, then you need to use class "iso-height-1" or "iso-height-2" to set the item height. If you use simple image tag, then don't use height classes.
								...
								<div class="isotope-item iso-height-1 print">
									...
									<!-- Begin portfolio list item -->
									<a href="portfolio-single-4.html" class="portfolio-list-item bg-image" style="background-image: url(assets/img/porfolio/portfolio-5.jpg); background-position: 50% 50%">
										<div class="pli-hover">
											<div class="pli-caption">
								...
								* If you use background image on isotope-item child element, then you need to use class "iso-height-1" or "iso-height-2" to set the item height. If you use simple image tag, then don't use height classes.
								-->
								<div class="isotope-item iso-height-2 web-design motion">

									<!-- Begin portfolio list item -->
									<a href="portfolio-single-5.html" class="portfolio-list-item bg-image" style="background-image: url(assets/img/porfolio/portfolio-4.jpg); background-position: 50% 50%">
										<div class="pli-hover">
											<div class="pli-caption">
								...
								* If you use background image on isotope-item child element, then you need to use class "iso-height-1" or "iso-height-2" to set the item height. If you use simple image tag, then don't use height classes.
								-->
								<div class="isotope-item iso-height-2 web-design">

									<!-- Begin portfolio list item -->
									<a href="portfolio-single-2.html" class="portfolio-list-item bg-image" style="background-image: url(assets/img/porfolio/portfolio-8.jpg); background-position: 50% 50%">
										<div class="pli-hover">
											<div class="pli-caption">
								...
								* If you use background image on isotope-item child element, then you need to use class "iso-height-1" or "iso-height-2" to set the item height. If you use simple image tag, then don't use height classes.
								-->
								<div class="isotope-item iso-height-1 photography">
								...
								* If you use background image on isotope-item child element, then you need to use class "iso-height-1" or "iso-height-2" to set the item height. If you use simple image tag, then don't use height classes.
								...
								<div class="isotope-item iso-height-1 photography">
									...
									<!-- Begin portfolio list item -->
									<a href="portfolio-single-3.html" class="portfolio-list-item bg-image" style="background-image: url(assets/img/porfolio/portfolio-9.jpg); background-position: 50% 50%">
										<div class="pli-hover">
											<div class="pli-caption">
								...
								* If you use background image on isotope-item child element, then you need to use class "iso-height-1" or "iso-height-2" to set the item height. If you use simple image tag, then don't use height classes.
								-->
								<div class="isotope-item iso-height-1 photography motion">

									<!-- Begin portfolio list item -->
									<a href="portfolio-single-4.html" class="portfolio-list-item bg-image" style="background-image: url(assets/img/porfolio/portfolio-10.jpg); background-position: 50% 50%">
										<div class="pli-hover">
											<div class="pli-caption">
								...
								* If you use background image on isotope-item child element, then you need to use class "iso-height-1" or "iso-height-2" to set the item height. If you use simple image tag, then don't use height classes.
								...
								<div class="isotope-item iso-height-1 print">
									...
									<!-- Begin portfolio list item -->
									<a href="portfolio-single-5.html" class="portfolio-list-item bg-image" style="background-image: url(assets/img/porfolio/portfolio-11.jpg); background-position: 50% 50%">
										<div class="pli-hover">
											<div class="pli-caption">
												<div><h2 class="pli-title">Ullam Zert Gampos</h2></div>
												<div><span class="pli-category">Print</span></div>
											</div>
											<div class="pli-arrow"></div>
										</div>
								...
								* If you use background image on isotope-item child element, then you need to use class "iso-height-1" or "iso-height-2" to set the item height. If you use simple image tag, then don't use height classes.
								...
								<div class="isotope-item iso-height-1 print motion">
									...
									<!-- Begin portfolio list item -->
									<a href="portfolio-single-1.html" class="portfolio-list-item bg-image" style="background-image: url(assets/img/porfolio/portfolio-12.jpg); background-position: 50% 50%">
										<div class="pli-hover">
											<div class="pli-caption">
												<div><h2 class="pli-title">Naires Trectum</h2></div>
												<div><span class="pli-category">Print, Motion</span></div>
											</div>
											<div class="pli-arrow"></div>
										</div>
								...
								* If you use background image on isotope-item child element, then you need to use class "iso-height-1" or "iso-height-2" to set the item height. If you use simple image tag, then don't use height classes.
								...
								<div class="isotope-item iso-height-2 print">
									...
									<!-- Begin portfolio list item -->
									<a href="portfolio-single-2.html" class="portfolio-list-item bg-image" style="background-image: url(assets/img/porfolio/portfolio-6.jpg); background-position: 50% 50%">
										<div class="pli-hover">
											<div class="pli-caption">
												<div><h2 class="pli-title">Ferritsia Nallo</h2></div>
												<div><span class="pli-category">Print</span></div>
											</div>
											<div class="pli-arrow"></div>
										</div>
								...
								* If you use background image on isotope-item child element, then you need to use class "iso-height-1" or "iso-height-2" to set the item height. If you use simple image tag, then don't use height classes.
								...
								<div class="isotope-item iso-height-1 print">
									...
									<!-- Begin portfolio list item -->
									<a href="portfolio-single-3.html" class="portfolio-list-item bg-image" style="background-image: url(assets/img/porfolio/portfolio-13.jpg); background-position: 50% 50%">
										<div class="pli-hover">
											<div class="pli-caption">
												<div><h2 class="pli-title">Ecora Betrum At Namez</h2></div>
												<div><span class="pli-category">Print</span></div>
											</div>
											<div class="pli-arrow"></div>
										</div>
								...
								* If you use background image on isotope-item child element, then you need to use class "iso-height-1" or "iso-height-2" to set the item height. If you use simple image tag, then don't use height classes.
								...
								<div class="isotope-item iso-height-1 print">
									...
									<!-- Begin portfolio list item -->
									<a href="portfolio-single-4.html" class="portfolio-list-item bg-image" style="background-image: url(assets/img/porfolio/portfolio-14.jpg); background-position: 50% 50%">
										<div class="pli-hover">
											<div class="pli-caption">
												<div><h2 class="pli-title">Vertima Latzeck</h2></div>
												<div><span class="pli-category">Print</span></div>
											</div>
											<div class="pli-arrow"></div>
										</div>
...
chatbotId: "KyCS4GcZqIT9IwqFbSgRr",
...
<!-- Mirrored from demo.themetorium.net/html/waldo/portfolio-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 01 Nov 2024 15:50:44 GMT -->
</html>